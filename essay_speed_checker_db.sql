...
(64, 'This is a simulated question.', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'gioteacher@gmail.com', '3', 0, '<&^>famous  as  a  heading.  <&^>dislocation,  <&^>manner  much  ground  an  object  has  hidden,  <&^>dislocation  shows  by  what  method  unusual  of  place  an  object  is.  <&^>Speed  and  Remove  are  scalar  amount  in  other  words  it  as  it  were  considers  the  greatness,  whereas  Speed  and  Uprooting  may  be  a  vector  amount  which  not  as  it  were  considers  the  greatness,  but  moreover  the  course  of  the  question.  <&^>When  The  Flash  reaches  his  destination,  he  can  activate  the  skill  again  to  return  to  where  he  started,  dealing  magic  damage.  Enemies  damaged  by  the  initial  dash  are  dealt  an  additional  magic  damage.  Shortly  after  settling  back  in  Titans  Tower,  Bart  reveals  to  Conner  that  during  his  brief  stay  in  the  future,  he  went  through  a  number  of  records  and  schematics  concerning  technology  from  the  era.  <&^>When  The  Flash  reaches  his  destination,  he  can  activate  the  skill  again  to  return  to  where  he  started,  dealing  magic  damage.  Enemies  damaged  by  the  initial  dash  are  dealt  an  additional  magic  damage.  Shortly  after  settling  back  in  Titans  Tower,  Bart  reveals  to  Conner  that  during  his  brief  stay  in  the  future,  he  went  through  a  number  of  records  and  schematics  concerning  technology  from  the  era.  <!@#CORRECT$%^><&*>Speed  and  distance  are  scalar  quantities,  in  other  words,  they  only  consider  size,  while  speed  and  displacement  are  vector  quantities,  which  consider  not  only  size  but  also  direction  of  the  object.  <&*>Speed  refers  to  an  object  travel  distance  over  period,  while  speed  is  fundamentally  speed  accompanying  an  addition  of  course  or  <&*>Concerning  the  distance  and  <&*>two  together  are  related,  but  the  center  dissimilarity  is  that  the  distance  understands  in  what  way  or  <&*>while  <&*>Speed  refers  to  an  object  travel  distance  over  time,  while  velocity  is  basically  speed  with  an  inclusion  of  direction  or  known  as  a  vector.  As  for  the  distance  and  displacement,  both  are  similar,  but  the  core  difference  is  that  the  distance  tells  how  much  ground  an  object  has  covered,  while  displacement  shows  how  far  out  of  place  an  object  is.  <&*>Speed  is  the  distance  an  object  travels  in  a  unit  of  time,  whereas  velocity  is  speed  plus  direction,  often  known  as  a  vector.  Although  distance  and  displacement  are  comparable,  they  differ  primarily  in  that  distance  indicates  how  much  ground  an  object  has  covered  and  displacement  indicates  how  far  an  object  has  moved  from  its  original  location.  <&*>Speed  is  the  amount  of  space  an  object  covers  in  a  given  amount  of  time,  whereas  velocity  is  simply  speed  plus  direction,  also  referred  to  as  a  vector.  The  difference  between  distance  and  displacement  is  that  while  both  measure  how  much  ground  an  object  has  covered,  displacement  demonstrates  how  far  an  object  has  moved  from  its  original  location.  <&*>Speed  refers  to  an  object  travel  distance  over  occasion,  while  speed  is  fundamentally  speed  accompanying  an  addition  of  management  or  popular  as  a  heading.  Concerning  the  distance  and  dislocation,  two  together  are  identical,  but  the  gist  dissimilarity  is  that  the  distance  reports  by  means  of  what  much  ground  an  object  has  dotted,  while  dislocation  shows  in  what  way  or  manner  unusual  of  place  an  object  is.  ');
...
(238, 'Speed and Distance are scalar quantity in other words it only considers the magnitude, while Velocity and Displacement is a vector quantity which not only considers the magnitude, but also the direction of the object.', 64, 'bot', '2023-02-22 16:09:15', 92.58, 2, 2),
(239, 'Speed talks about how fast and velocity also fast but with a sense of route. Distance and Displacement may look the same if we only calculate one line, but with more multiple lines we can easily differ displacement from distance.', 64, 'bot', '2023-02-22 16:09:15', 72.98, 2, 1),
(240, 'If the object heads only from point A to point B without any form of direction then it is scalar value, but if the object has some direction, then it is considered a vector value.', 64, 'bot', '2023-02-22 16:09:15', 56.58, 2, 3),
...
(246, 'Speed and Distance are scalar quantity in other words it only considers the magnitude, while Velocity and Displacement is a vector quantity which not only considers the magnitude, but also the direction of the object.', 64, 'bot', '2023-02-22 16:09:15', 92.58, 2, 2),
...
(252, 'Speed alludes to an question travel remove over time, whereas speed is essentially speed with an consideration of heading or known as a vector. As for the remove and uprooting, both are comparable, but the center distinction is that the separate tells how much ground an question has secured, whereas uprooting appears how distant out of put an protest is.', 64, 'bot', '2023-02-22 16:09:15', 59.13, 2, 2),
(253, 'Speed and Remove are scalar amount in other words it as it were considers the greatness, whereas Speed and Uprooting may be a vector amount which not as it were considers the greatness, but moreover the course of the question.', 64, 'bot', '2023-02-22 16:09:15', 54.55, 2, 3),
(254, 'Speed and Distance are scalar amount in different phrases it handiest considers the magnitude, even as Velocity and Displacement is a vector amount which now no longer handiest considers the magnitude, however additionally the course of the object.', 64, 'bot', '2023-02-22 16:09:15', 62.55, 2, 2),
(255, 'Speed and Distance are scalar amount in different words it solely considers the magnitude, whereas rate and Displacement could be a vector quantity that not only considers the magnitude, however conjointly the direction of the object.', 64, 'bot', '2023-02-22 16:09:15', 74.54, 2, 2),
(256, 'Speed and distance are scalar quantities, in other words, they only consider size, while speed and displacement are vector quantities, which consider not only size but also direction of the object.', 64, 'bot', '2023-02-22 16:09:15', 100, 1, -1),
(257, 'Speed refers to an object travel distance over period, while speed is fundamentally speed accompanying an addition of course or famous as a heading. Concerning the distance and dislocation, two together are related, but the center dissimilarity is that the distance understands in what way or manner much ground an object has hidden, while dislocation shows by what method unusual of place an object is.', 64, 'bot', '2023-02-22 16:09:15', 64.62, 1, -1),
...
(260, 'Speed and Remove are scalar amount in other words it as it were considers the greatness, whereas Speed and Uprooting may be a vector amount which not as it were considers the greatness, but moreover the course of the question.', 64, 'bot', '2023-02-22 16:09:15', 0, 1, -1),
(261, 'The ancient Greeks called cake πλακοῦς (plakous), which was derived from the word for \"flat\", πλακόεις (plakoeis). It was baked using flour mixed with eggs, milk, nuts, and honey. They also had a cake called \"satura\", which was a flat heavy cake. During the Roman period, the name for cake became \"placenta\" which was derived from the Greek term. A placenta was baked on a pastry base or inside a pastry case.', 64, 'bot', '2023-02-22 16:09:15', 4.89, 2, 0),
(262, 'American teenager Peter Parker, a poor sickly orphan, is bitten by a radioactive spider. As a result of the bite, he gains superhuman strength, speed, and agility, along with the ability to cling to walls, turning him into Spider-Man. Parker also acquired a precognitive “spidey-sense” that alerted him to approaching dangers.', 64, 'bot', '2023-02-22 16:09:16', 16.25, 2, 0),
(263, 'When The Flash reaches his destination, he can activate the skill again to return to where he started, dealing magic damage. Enemies damaged by the initial dash are dealt an additional magic damage. Shortly after settling back in Titans Tower, Bart reveals to Conner that during his brief stay in the future, he went through a number of records and schematics concerning technology from the era.', 64, 'bot', '2023-02-22 16:09:16', 0, 1, 0),
(264, 'A dissertation tesis doctoral, with an average of 250 pages, is the main requisite along with typically one previously published journal article. Once candidates have published their written dissertations, they will be evaluated by two external academics evaluadores externos and subsequently it is usually exhibited publicly for fifteen natural days.', 64, 'bot', '2023-02-22 16:09:16', 0, 2, 0),
(265, 'Glory to God in the highest And on earth, peace to people of good will We praise You We bless You We adore You We glorify You We give You thanks for Your great glory Lord God, heavenly king O God, almighty Father Lord Jesus Christ Only begotten Son Lord God, Lamb of God Son of the Father You take away the sins of the world Have mercy on us You take away the sins of the world Receive our prayer You are seated at the right hand of the Father Have mercy on us For You alone are the Holy One You alone are the Lord You alone are the Most High, Jesus Christ With the Holy Spirit In the glory of God, the Father Amen', 64, 'bot', '2023-02-22 16:09:16', 0, 2, 0),
(306, 'Ohh it is an answered simulated question.', 64, 'giostudent@gmail.com', '2023-03-08 22:50:51', 0, 0, -1);
...
(38, 'bot', 'bot', 'none', '00000000000', 0, 'profiles/profile_pic');
...
--
ALTER TABLE `student_answers`
  MODIFY `answer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=307;

--
-- AUTO_INCREMENT for table `teacher_student_connection`
--
ALTER TABLE `teacher_student_connection`
  MODIFY `t_s_conn_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
